...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { email: @participant.email, name: @participant.name, phone_no: @participant.phone_no } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { email: @participant.email, name: @participant.name, phone_no: @participant.phone_no } }
